...
sub _validate {
    defined (is_int($_[1])) ? return $_[1] : return undef;
}

sub _fix {
    defined(is_float($_[1])) ? return int($_[1]) : return $_[0]->get_default;
}
...
The B<fix> function returns the input as an integer (if the input is
numeric), or otherwise the current default.
